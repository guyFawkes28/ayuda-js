...
<body>
    ...
    <main class="container d-flex flex-grow-1 align-items-center justify-content-center py-5">
        <div class="error-card text-center">
            <svg class="error-icon mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
            </svg>
            <h2 class="h4 fw-bold mb-3 text-dark">Error al cargar los datos</h2>
            <p class="text-muted mb-4">No se pudo conectar con la API de Open Meteo. Por favor, verifica tu conexión a internet e intenta nuevamente.</p>
